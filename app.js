...
const PROJECTS = [
{id:25,name:'Neural Network-Assisted Key Rate Estimation in Noisy QKD Channels',faculty:'A V Amruthesh Bhat',domain:'AI/ML',status:'On Track',progress:82,w7:'Submitted'},
{id:9,name:'Benchmarking NIST PQC Standards on Constrained IoT Devices',faculty:'A V Amruthesh Bhat',domain:'Cybersecurity',status:'On Track',progress:76,w7:'Pending'},
...
{id:19,name:'Insider Threat Detection Using Behavioral Analytics',faculty:'Dr Basavaraj Patil',domain:'Data Science',status:'Needs Review',progress:58,w7:'Pending'},
...
{id:23,name:'LLM-Assisted Malware Reverse Engineering and Explainable Threat Report Generation',faculty:'Dr. Manish Kumar',domain:'Cybersecurity',status:'On Track',progress:83,w7:'Submitted'},
...
{id:18,name:'Hybrid Cryptography Framework for Quantum-Safe Secure Communication',faculty:'Dr. Manish Kumar',domain:'Cybersecurity',status:'On Track',progress:72,w7:'Submitted'},
...
{id:13,name:'Develop a secure prompt validation and response filtering model to protect LLM applications from safety bypass and policy evasion attacks.',faculty:'Dr.Sarasvathi V',domain:'Cybersecurity',status:'Needs Review',progress:59,w7:'Submitted'},
{id:12,name:'Design a secure framework for detecting, preventing, and mitigating Tool Poisoning/MCP attacks in agentic AI systems',faculty:'Dr.Sarasvathi V',domain:'Cybersecurity',status:'Delayed',progress:42,w7:'Pending'},
...
{id:5,name:'AI-Driven Adaptive Intrusion Detection and Network Threat Intelligence Framework',faculty:'Sunilkumar J',domain:'Cybersecurity',status:'On Track',progress:79,w7:'Pending'},
